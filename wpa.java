...
alphabet="fabcdeghijklmnopqrstuvwxyz\1\2";
//for(int i='a';i<='z';i++)
//{
//if(alphabet.indexOf((char)i)<0)
...
System.out.println(lcsBeginIndex+" "+lcsLength+" "+s+" "+alphabet);
if(lcsLength>0)
{
System.out.println(s.substring(lcsBeginIndex,lcsBeginIndex+lcsLength));
